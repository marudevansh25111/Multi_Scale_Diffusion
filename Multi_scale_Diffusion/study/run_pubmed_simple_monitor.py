...
def run_single_experiment(alpha, t):
    ...
    class Args:
        dataset = "Pubmed"  # Change this for different datasets
        hidden_dims = 256
        walk_length = 3
        walks_per_node = 10
        batch_size = 256
        lr = 0.01
        epochs = 100 # Reduce epochs for parameter study
        log_steps = 1
    ...
    dataset = Planetoid(root='.', name='Pubmed')  # Change dataset name as needed
